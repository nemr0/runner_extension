...
const ProjectSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'projectType': PropertySchema(
      ...
      name: r'projectType',
      type: IsarType.byte,
      enumMap: _ProjectprojectTypeEnumValueMap,
    )
  },
...
void _projectSerialize(
  ...
  writer.writeByte(offsets[2], object.projectType.index);
}
...
Project _projectDeserialize(
  ...
  final object = Project(
    ...
    projectType:
        _ProjectprojectTypeValueEnumMap[reader.readByteOrNull(offsets[2])] ??
            ProjectType.flutter,
  );
  return object;
}
...
P _projectDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 2:
      return (_ProjectprojectTypeValueEnumMap[reader.readByteOrNull(offset)] ??
          ProjectType.flutter) as P;
    default:
      throw IsarError('Unknown property with id $propertyId');
  }
}

const _ProjectprojectTypeEnumValueMap = {
  'flutter': 0,
  'dart': 1,
  'other': 2,
  'none': 3,
};
const _ProjectprojectTypeValueEnumMap = {
  0: ProjectType.flutter,
  1: ProjectType.dart,
  2: ProjectType.other,
  3: ProjectType.none,
};
...
extension ProjectQuerySortBy on QueryBuilder<Project, Project, QSortBy> {
  ...
  QueryBuilder<Project, Project, QAfterSortBy> sortByProjectType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'projectType', Sort.asc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> sortByProjectTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'projectType', Sort.desc);
    });
  }
}
...
extension ProjectQuerySortThenBy
  ...
  QueryBuilder<Project, Project, QAfterSortBy> thenByProjectType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'projectType', Sort.asc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> thenByProjectTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'projectType', Sort.desc);
    });
  }
...
extension ProjectQueryWhereDistinct
  ...
  QueryBuilder<Project, Project, QDistinct> distinctByProjectType() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'projectType');
    });
  }
}
...
extension ProjectQueryProperty
  ...
  QueryBuilder<Project, ProjectType, QQueryOperations> projectTypeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'projectType');
    });
  }
}
